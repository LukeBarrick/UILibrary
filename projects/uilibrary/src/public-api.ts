...
export * from './lib/modules/text-inputs/text-input/text-input.component';
export * from './lib/modules/text-inputs/text-area/text-area.component';
...
export * from './lib/modules/buttons/button/button.component';
