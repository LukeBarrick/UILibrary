...
describe('ContextSideMenuComponent', () => {
    ...
    it('should create', () => {
        expect(MockRender(ContextSideMenuComponent).point.componentInstance).toBeTruthy();
    });

    describe('disabled input', () => {
        it('should default to false', () => {
            expect(MockRender(ContextSideMenuComponent, { disabled: false }).point.componentInstance.disabled).toBeFalse();
        });
